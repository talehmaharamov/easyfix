...
class NewsletterController extends Controller
{
    public function index()
    {
        ...
        return view('backend.system.newsletter.index', get_defined_vars());
    }
    ...
    public function newsletterHistory()
    {
        ...
        return view('backend.system.newsletter.history', get_defined_vars());
    }

    public function create()
    {
        abort_if(Gate::denies('newsletter create'), Response::HTTP_FORBIDDEN, '403 Forbidden');
        return view('backend.system.newsletter.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        foreach ($subscribers as $subscriber) {
            ...
            Mail::send('backend.system.mail.send', $data, function ($message) use ($subscriber, $data) {
