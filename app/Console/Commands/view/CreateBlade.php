...
class CreateBlade extends Command
{
    ...
    public function handle()
    {
        ...
        $copyFromIndex = resource_path('views/backend/system/templates/multi-language/index.blade.php');
        ...
        $copyFromEdit = resource_path('views/backend/system/templates/multi-language/edit.blade.php');
        $copyFromContentsEdit = file_get_contents($copyFromEdit);
        $copyFromContentsEdit = str_replace('selection', $name, $copyFromContentsEdit);

        $copyFromCreate = resource_path('views/backend/system/templates/multi-language/create.blade.php');
