                ...
                <div class="single-colution-details-plumber">
                    <div class="icon">
                        <svg width="100" height="100" viewBox="0 0 100 100" fill="none"
                            ...
                            <circle cx="50" cy="50" r="50" fill="#0a92d3" fill-opacity="0.1"/>
                            <path
                ...
                <div class="single-colution-details-plumber">
                    <div class="icon">
                        ...
                        <svg width="100" height="100" viewBox="0 0 100 100" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <circle cx="50" cy="50" r="50" fill="#0a92d3" fill-opacity="0.1"/>
                            <path d="M60.1613 85.4516H62.4194V94.4839H60.1613V85.4516Z" fill="#0a92d3"/>
                            <path d="M64.6774 85.4516H66.9355V94.4839H64.6774V85.4516Z" fill="#0a92d3"/>
                            <path
                                ...
                                fill="#0a92d3"/>
                            <path d="M48.871 65.129H51.129V67.3871H48.871V65.129Z" fill="#0a92d3"/>
                            <path d="M48.871 92.2258H51.129V94.4839H48.871V92.2258Z" fill="#0a92d3"/>
                            <path d="M48.871 69.6452H51.129V71.9032H48.871V69.6452Z" fill="#0a92d3"/>
                            <path d="M48.871 87.7097H51.129V89.9677H48.871V87.7097Z" fill="#0a92d3"/>
                            <path d="M48.871 78.6774H51.129V80.9355H48.871V78.6774Z" fill="#0a92d3"/>
                            <path d="M48.871 74.1613H51.129V76.4194H48.871V74.1613Z" fill="#0a92d3"/>
                            <path d="M48.871 83.1936H51.129V85.4516H48.871V83.1936Z" fill="#0a92d3"/>
                            <path d="M53.3871 74.1613H55.6452V76.4194H53.3871V74.1613Z" fill="#0a92d3"/>
                            <path d="M53.3871 69.6452H55.6452V71.9032H53.3871V69.6452Z" fill="#0a92d3"/>
                            <path d="M53.3871 65.129H55.6452V67.3871H53.3871V65.129Z" fill="#0a92d3"/>
                            <path d="M78.2258 92.2258H80.4839V94.4839H78.2258V92.2258Z" fill="#0a92d3"/>
                            <path d="M78.2258 83.1936H80.4839V85.4516H78.2258V83.1936Z" fill="#0a92d3"/>
                            <path d="M78.2258 87.7097H80.4839V89.9677H78.2258V87.7097Z" fill="#0a92d3"/>
                            <path d="M78.2258 78.6774H80.4839V80.9355H78.2258V78.6774Z" fill="#0a92d3"/>
                            <path d="M78.2258 74.1613H80.4839V76.4194H78.2258V74.1613Z" fill="#0a92d3"/>
                            <path d="M73.7097 87.7097H75.9677V89.9677H73.7097V87.7097Z" fill="#0a92d3"/>
                            <path d="M73.7097 74.1613H75.9677V76.4194H73.7097V74.1613Z" fill="#0a92d3"/>
                            <path d="M73.7097 83.1936H75.9677V85.4516H73.7097V83.1936Z" fill="#0a92d3"/>
                            <path d="M73.7097 92.2258H75.9677V94.4839H73.7097V92.2258Z" fill="#0a92d3"/>
                            <path d="M73.7097 78.6774H75.9677V80.9355H73.7097V78.6774Z" fill="#0a92d3"/>
                            <path d="M39.8387 44.8065H42.0968V47.0645H39.8387V44.8065Z" fill="#0a92d3"/>
                            <path d="M35.3226 44.8065H37.5806V47.0645H35.3226V44.8065Z" fill="#0a92d3"/>
                            <path d="M26.2903 44.8065H28.5484V47.0645H26.2903V44.8065Z" fill="#0a92d3"/>
                            <path d="M30.8065 44.8065H33.0645V47.0645H30.8065V44.8065Z" fill="#0a92d3"/>
                            <path d="M30.8065 49.3226H33.0645V51.5806H30.8065V49.3226Z" fill="#0a92d3"/>
                            <path d="M39.8387 49.3226H42.0968V51.5806H39.8387V49.3226Z" fill="#0a92d3"/>
                            <path d="M26.2903 49.3226H28.5484V51.5806H26.2903V49.3226Z" fill="#0a92d3"/>
                            <path d="M35.3226 49.3226H37.5806V51.5806H35.3226V49.3226Z" fill="#0a92d3"/>
                            <path d="M26.2903 53.8387H28.5484V56.0968H26.2903V53.8387Z" fill="#0a92d3"/>
                            <path d="M30.8065 53.8387H33.0645V56.0968H30.8065V53.8387Z" fill="#0a92d3"/>
                            <path d="M35.3226 53.8387H37.5806V56.0968H35.3226V53.8387Z" fill="#0a92d3"/>
                            <path d="M69.1936 49.3226H71.4516V51.5806H69.1936V49.3226Z" fill="#0a92d3"/>
                            <path d="M64.6774 49.3226H66.9355V51.5806H64.6774V49.3226Z" fill="#0a92d3"/>
                            <path d="M60.1613 49.3226H62.4194V51.5806H60.1613V49.3226Z" fill="#0a92d3"/>
                            <path d="M69.1936 53.8387H71.4516V56.0968H69.1936V53.8387Z" fill="#0a92d3"/>
                            <path d="M60.1613 53.8387H62.4194V56.0968H60.1613V53.8387Z" fill="#0a92d3"/>
                            <path d="M64.6774 53.8387H66.9355V56.0968H64.6774V53.8387Z" fill="#0a92d3"/>
                            <path d="M64.6774 67.3871H66.9355V69.6452H64.6774V67.3871Z" fill="#0a92d3"/>
                            <path d="M64.6774 62.871H66.9355V65.129H64.6774V62.871Z" fill="#0a92d3"/>
                            <path d="M64.6774 58.3548H66.9355V60.6129H64.6774V58.3548Z" fill="#0a92d3"/>
                            <path d="M69.1936 62.871H71.4516V65.129H69.1936V62.871Z" fill="#0a92d3"/>
                            <path d="M69.1936 58.3548H71.4516V60.6129H69.1936V58.3548Z" fill="#0a92d3"/>
                        </svg>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="cta-two-main-wrapper">
                        <div class="title-area-left">
                            <h2 class="title">
                                @lang('backend.ready-to-experience')
                            </h2>
                        </div>
                        <div class="cta-button-area">
                            <a href="/contact#secSection" class="rts-btn btn-primary">
