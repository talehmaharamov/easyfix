                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">@lang('backend.product'):</h4>
                                <a href="{{ route('backend.product.create') }}" class="btn btn-primary mb-3"><i
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            @foreach($products as $product)
                                <tr>
                                    ...
                                    @include('backend.system.templates.components.dt-settings',['variable' => 'product','value' => $product])
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
