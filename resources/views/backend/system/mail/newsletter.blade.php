        ...
        <td bgcolor="#252b3b" align="center" style="padding: 0px 10px 0px 10px">
            ...
            >
                ...
                "
                    >
                        <img
                            src="https://i.ibb.co/Kz1mw0y/logo.png"
                            width="125"
                            height="120"
        ...
        <td bgcolor="#f4f4f4" align="center" style="padding: 0px 10px 0px 10px">
            ...
            >
                ...
                "
                    >
                        ...
                        <p style="margin: 0;color: black">
                            Abonə olmaq üçün zəhmət olmasa,mailinizi təsdiqləyin!
                        </p>
                    </td>
                </tr>
                <tr>
                                ...
                                >
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            >
                                                <a
                                                    href="{{ route('frontend.verifyMail',['id' => $id,'token' => $token])}}"
                                                    target="_blank"
                                                    style="
                                font-size: 20px;
                ...
                "
                    >
                        <p style="margin: 0">
                            Bu işləmirsə, aşağıdakı linki kopyalayıb brauzerinizə yapışdırın:
                        </p>
                    </td>
                </tr>
                <!-- COPY -->
                ...
                "
                    >
                        <p style="margin: 0">
                            <a href="{{ route('frontend.verifyMail',['id' => $id,'token' => $token])}}" target="_blank" style="color: #252b3b"
                            >{{ route('frontend.verifyMail',['id' => $id,'token' => $token])}}</a
                            >
                        </p>
                    </td>
                </tr>
                ...
                "
                    >
                        <p style="margin: 0;">Hörmətlə,<br/>Dırnıs Xeyriyyə Cəmiyyəti</p>
                    </td>
                </tr>
            </table>
        </td>
            ...
            >
                ...
                "
                    >
                        ...
                        <p style="margin: 0">
                            <a href="{{ route('frontend.contact-page') }}" target="_blank" style="color: #252b3b"
