                ...
                <div class="card-body">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <a  class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center"><i class="fas fa-plus"></i>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="{{ asset($sl->icon) }}" width="32" height="24" alt="{{ $sl->name }}">
                                </td>
                                @include('backend.system.templates.components.dt-settings',['variable' => 'site-languages','value' => $sl])
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
